...
export class MintDegenWithCharacterTraitsCall extends ethereum.Call {
  get inputs(): MintDegenWithCharacterTraitsCall__Inputs {
    return new MintDegenWithCharacterTraitsCall__Inputs(this);
  }

  get outputs(): MintDegenWithCharacterTraitsCall__Outputs {
    return new MintDegenWithCharacterTraitsCall__Outputs(this);
  }
}

export class MintDegenWithCharacterTraitsCall__Inputs {
  _call: MintDegenWithCharacterTraitsCall;

  constructor(call: MintDegenWithCharacterTraitsCall) {
    this._call = call;
  }

  get _characterTraits(): MintDegenWithCharacterTraitsCall_characterTraitsStruct {
    return changetype<MintDegenWithCharacterTraitsCall_characterTraitsStruct>(
      this._call.inputValues[0].value.toTuple()
    );
  }
}

export class MintDegenWithCharacterTraitsCall__Outputs {
  _call: MintDegenWithCharacterTraitsCall;
...
export class MintDegenWithCharacterTraitsCall_characterTraitsStruct extends ethereum.Tuple {
  get tribe(): i32 {
    return this[0].toI32();
  }
